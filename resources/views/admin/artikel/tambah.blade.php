        ...
        <div class="body">
            ...
            <form action="{{ url('admin/artikel/tambah') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-1">
                    ...
                    <div>
                        <label for="default-editor" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Isi Artikel</label>
                        <textarea type="text" id="default-editor" name="isi" class="bg-white/30 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Isi artikel ..." ></textarea>
                    </div>
                </div>
